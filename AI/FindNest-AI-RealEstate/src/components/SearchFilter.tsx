...
export default function SearchFilter({
  ...
  return (
    <div className="relative z-50 bg-white/60 backdrop-blur-2xl p-3 md:p-4 rounded-2xl md:rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.08)] border border-white w-full max-w-6xl mx-auto ring-1 ring-white/60 transition-all duration-500 hover:shadow-[0_20px_60px_rgba(29,78,216,0.15)]">
      <div className="grid grid-cols-2 lg:grid-cols-[repeat(5,1fr)_auto] gap-2 lg:gap-2.5">
